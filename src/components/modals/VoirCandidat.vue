    ...
    <div class="modal" v-if="show.showModalOeilCandidat">
      <div class="contenaireModal">
        ...
        <div class="flex">
          ...
          <div class="section">
            <div class="inputCard">
              ...
              <input type="text" placeholder="Ajoutez un nom" class="input" v-model="listeCandidat.voirCandidatData.electeur.nomComplet" />
            </div>
          ...
          <div class="section">
            ...
            <div class="inputCard">
              ...
              <select class="annee" v-model="listeCandidat.voirCandidatData.candidat.certificatAdministrationFiscale" id="">
                <option disabled value="">Obtention</option>
                <option value="oui">Oui</option>
                <option value="non">Non</option>
          ...
          <div class="section">
            ...
            <div class="inputCard">
              ...
              <select class="annee" v-model="listeCandidat.voirCandidatData.candidat.declarationHonneurConstitution" id="">
                <option disabled value="">Obtention</option>
                <option value="oui">Oui</option>
                <option value="non">Non</option>
        ...
        <div class="modalFooter">
          <h3 class="btnAdd cancel" @click="show.showModalOeilCandidat = !show.showModalOeilCandidat">Fermer</h3>
        </div>
      </div>
    </div>
