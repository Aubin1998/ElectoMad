<template>
  <Transition>
    <div class="showModal backdrop-blur p-2px" v-if="show.modalAssignerDeleduer">
      <div class="modal">
        <div class="closeForm" @click="show.modalAssignerDeleduer = !show.modalAssignerDeleduer">
        ...
        <div class="contenaireModal">
          <div class="content">
            ...
            <div class="contenaireModal" v-if="show.see">
              <h1 class="tritreModal  text-[23px]">Modifier en Delegue de vote</h1>
              <div class="contenaire ">
                <!-- {{ show.modalAssignerDeleduerData }}
                {{ show.modalAssignerDeleduerData.annee_electorale_id }} -->
                ...
                <div class="w-full h-[55vh] overflow-y-scroll px-2">
                  <template v-if="filteredElecteurs">
                    <div class="grid grid-cols-1 gap-y-1">
                      <div v-for="electeur in filteredElecteurs" :key="electeur.id" @click="selectCandidat(electeur)"
                        class="flex items-center justify-between bg-white px-4 py-1 rounded shadow hover:bg-blue-200">
                        <div class="flex-1 text-sm font-semibold text-gray-800 ">
                          {{ electeur.electeur.nomComplet }}
                        </div>
                  ...
                  <template v-else>
                    <div class="font-bold text-xl">Aucun Candidat trouvé</div>
                  </template>
                </div>
              </div>
