    ...
    <div class="bg-gray-100 py-24 sm:py-32">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0 bg-white p-8 rounded-lg shadow-lg">
          <h2 class="text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Liste électorale législative</h2>
          <p class="mt-2 text-lg text-gray-600">
            Consultez la liste des électeurs inscrits pour les élections législatives.
          </p>
        </div>
        ...
        <div v-if="searchResult" class="mt-10 max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-lg">
          <div v-if="searchResult.found" class="text-green-600">
            <p>L'électeur est inscrit sur la liste électorale législative.</p>
          ...
          <div v-else class="text-red-600">
            <p>L'électeur n'est pas inscrit sur la liste électorale législative. Veuillez vérifier l'orthographe ou contacter les autorités électorales pour plus d'informations.</p>
          </div>
        </div>
        ...
        <div class="mt-16 max-w-2xl mx-auto">
          ...
          <p class="mt-2 text-gray-600">
            Si vous avez des questions ou des préoccupations concernant votre inscription sur la liste électorale législative, veuillez contacter les autorités électorales locales.
          </p>
          <p class="mt-2 text-gray-600">
