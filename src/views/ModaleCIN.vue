    ...
    <div class="modal-container bg-contact-grayscale" v-if="show.showModalCIN">
      <div class="modal-content bg-contact-grayscale">
        ...
        <div class="image-container">
          ...
          <img :src="listeElecteur.electeurFind.file.titre" alt="Left Image"
            class="left-image duration-200 hover:scale-95" style="cursor:pointer " @click="gotoPhotoId" />
          <div class="right-images">
            <h2>Recto de la pièce d'identité</h2>
            <img :src="listeElecteur.electeurFind.electeur.recto_c_i_n_file.titre" alt="Top Right Image"
              class="top-right-image duration-200 hover:scale-95" style="cursor:pointer " @click="gotoRectoCIN" />
            <h2 class="pt-4">Verso de la pièce d'identité</h2>
            <img :src="listeElecteur.electeurFind.electeur.verso_c_i_n_file.titre" alt="Bottom Right Image"
              class="bottom-right-image duration-200 hover:scale-95" style="cursor:pointer " @click="gotoVersoCIN" />
          </div>
        </div>
